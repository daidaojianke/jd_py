...
# 东东农场每三小时执行一次
0 */3 * * * sleep $[$RANDOM%101+1] && /usr/local/bin/python /jd_scripts/jd_farm.py >> /jd_scripts/logs/jd_farm.log 2>&1

# 京东金融养猪猪
0 */3 * * * sleep $[$RANDOM%101+1] && /usr/local/bin/python /jd_scripts/jd_pet_pig.py >> /jd_scripts/logs/jd_pet_pig.log 2>&1
