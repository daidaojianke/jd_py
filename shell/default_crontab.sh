###  签到合集, 每天00:00执行 ###
0 0 * * * /usr/local/bin/python /jd_scripts/jd_sign_collection.py  >> /jd_scripts/logs/jd_sign_collection.log  2>&1

### 大赢家翻翻乐 每小时翻一次 ###
* */1 * * *  /usr/local/bin/python /jd_scripts/jd_big_winner.py  >> /jd_scripts/logs/jd_big_winner.log  2>&1
...
3 0 * * * /usr/local/bin/python /jd_scripts/jd_planting_bean.py  >> /jd_scripts/logs/jd_planting_bean.log  2>&1
